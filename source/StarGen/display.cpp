...
char *type_string (planet_type type)
{
	...
	switch (type)
	{
		case tUnknown:			typeString = (char*)"Unknown";		break;
		case tRock:				typeString = (char*)"Rock";		break;
		case tVenusian:			typeString = (char*)"Venusian";	break;
		case tTerrestrial:		typeString = (char*)"Terrestrial";	break;
		case tSubSubGasGiant:	typeString = (char*)"GasDwarf";	break;
		case tSubGasGiant:		typeString = (char*)"Sub-Jovian";	break;
		case tGasGiant:			typeString = (char*)"Jovian";		break;
		case tMartian:			typeString = (char*)"Martian";		break;
		case tWater:			typeString = (char*)"Water";		break;
		case tIce:				typeString = (char*)"Ice";			break;
		case tAsteroids: 		typeString = (char*)"Asteroids";	break;
		case t1Face:			typeString = (char*)"1Face";		break;
	}
	return typeString;
}
...
char *texture_name (planet_type type)
{
	...
	switch (type)
	{
		case tUnknown:			typeString = (char*)"x.jpg";			break;
		case tRock:				typeString = (char*)"callisto.jpg";	break;
		case tVenusian:			typeString = (char*)"venuslike.jpg";	break;
		case tTerrestrial:		typeString = (char*)"Earthlike.png";	break;
		case tSubSubGasGiant:	typeString = (char*)"x.jpg";			break;
		case tSubGasGiant:		typeString = (char*)"gasgiant.jpg";	break;
		case tGasGiant:			typeString = (char*)"jupiterlike.jpg";	break;
		case tMartian:			typeString = (char*)"mars.jpg";		break;
		case tWater:			typeString = (char*)"x.jpg";			break;
		case tIce:				typeString = (char*)"pluto.jpg";		break;
		case tAsteroids: 		typeString = (char*)"asteroid.jpg";	break;
		case t1Face:			typeString = (char*)"x.jpg";			break;
	}
	return typeString;
}
	...
	if (terrestrials && terrestrials_seen)
	{
			...
			planet=planet->next_planet, counter++)
		{
				...
				(planet->type != tSubSubGasGiant))
			{
				...
				print_description(file, (char*)"", planet, (char*)"");
				...
				moon=moon->next_planet, moons++)
			{
					...
					(moon->type != tSubSubGasGiant))
				{
					...
					print_description(file, (char*)"", moon, (char*)"");
						 ...
						 FILE*			file)
{
	...
	print_description(file, (char*)"<br>", planet, (char*)"");
