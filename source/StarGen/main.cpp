...
{{1.00,		1.00,	0,		0,		0,		 &mercury,	(char*)"Sol",		 	 1, (char*)"The Solar System"},
 {1.24,		1.047,	1.0,	0.05,	79.2,	 &manticore,(char*)"Manticore A",	 1, (char*)"Manticore A"},
 {1.0,		1.00,	1.047,	0.05,	79.2,	 NULL,		(char*)"Manticore B",	 1, (char*)"Manticore B"},
};

catalog	manticore_cat	= {sizeof(manticores) / sizeof (star),	(char*)"B", &manticores};

star	helios[] = 
// L		Mass	Mass2	Eccen.	SMAxis	 Planets	Designation		Name
{{1.00,		1.00,	0,		0,		0,		 &mercury,	(char*)"Sol",		 1, (char*)"The Solar System"},
 {1.08,		1.0,	0.87,	0.45,	8.85,	 NULL,		(char*)"Helio A",	 1, (char*)"Helio A"},
 {0.83,		0.87,	1.0,	0.45,	8.85,	 NULL,		(char*)"Helio B",	 1, (char*)"Helio B"},
};

catalog	helio		= {sizeof(helios) / sizeof (star), (char*)"?",	&helios};
...
{{1.00,		1.00,	0,		0,		0,		 &mercury,	(char*)"Sol",		1, (char*)"The Solar System"},
{0.0016,	0.32,	0,		0,		0,		 &ilaqrd,	(char*)"IL Aqr",	1, (char*)"IL Aquarii/Gliese 876"}	// 15.2
};

catalog	ilAqr_cat		= {sizeof(ilAqrs) / sizeof (star),	(char*)"G", &ilAqrs};
 */
