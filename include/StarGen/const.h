#ifndef __Mizar5__STARGEN__const__
#define __Mizar5__STARGEN__const__
...
#define K_STARGEN						(50.0)			/* K = gas/dust ratio		*/
#define B_STARGEN						(1.2E-5)		/* Used in Crit_mass calc	*/
#define DUST_DENSITY_COEFF		(2.0E-3)		/* A in Dole's paper		*/
#define ALPHA_STARGEN					(5.0)			/* Used in density calcs	*/
#define N_STARGEN						(3.0)			/* Used in density calcs	*/
#define J_STARGEN						(1.46E-19)		/* Used in day-length calcs (cm2/sec2 g) */
#ifdef HUGE_VAL
